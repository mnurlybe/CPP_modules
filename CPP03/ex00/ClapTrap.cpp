...
/*   Updated: 2024/04/10 15:54:06 by julienmoign      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const ClapTrap &obj)
{
    ...
    energy = obj.energy;
    damage = obj.damage;
    std::cout << "Copy " << name << " is created." << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap& obj){
    ...
    energy = obj.energy;
    damage = obj.damage;
    std::cout << "New " << name << " is assigned." << std::endl;
    return *this;
}

ClapTrap::~ClapTrap(){
    std::cout << "Desctructor: " << name << " is terminated!" << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount){
    if (hit > 0){
        ...
        std::cout << "Not " << name << " enough hit points to repair!" << std::endl;
    }
}

void ClapTrap::get_data(void){
    std::cout << "Hit points: " << hit << "; Energy points: " << energy << "; Damange: " << damage << std::endl;
}
